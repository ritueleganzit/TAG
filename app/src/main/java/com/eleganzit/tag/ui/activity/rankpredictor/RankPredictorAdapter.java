...
public class RankPredictorAdapter extends RecyclerView.Adapter<RankPredictorAdapter.MyViewHolder>
{

    Context context;
    Activity activity;
    public RankPredictorAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_rankpredictor,viewGroup,false);
