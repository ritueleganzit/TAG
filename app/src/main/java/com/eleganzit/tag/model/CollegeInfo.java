...
public class CollegeInfo {
    ...
    @SerializedName("enterance_exam_accept")
    @Expose
    private String enteranceExamAccept;
    ...
    public void setIsUniversity(String isUniversity) {
    ...
    public String getEnteranceExamAccept() {
        return enteranceExamAccept;
    }

    public void setEnteranceExamAccept(String enteranceExamAccept) {
        this.enteranceExamAccept = enteranceExamAccept;
    }
