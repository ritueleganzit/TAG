...
public class CollegeGalleryInfraAdapter extends RecyclerView.Adapter<CollegeGalleryInfraAdapter.MyViewHolder> {
    String status,status_name,progress_name;
    ArrayList<Infrastructure> arr;
    Context context;
    int h;
    Activity activity;
    ProgressDialog progressDialog;

    public CollegeGalleryInfraAdapter(ArrayList<Infrastructure> arr, LinearLayout linearlayoutsize, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        Infrastructure courseDetail=arr.get(i);
