...
public class SchoolGalleryAdapter extends RecyclerView.Adapter<SchoolGalleryAdapter.MyViewHolder> {
    String status,status_name,progress_name;
    ArrayList<Gallery> arr;
    Context context;
    int h;
    Activity activity;
    ProgressDialog progressDialog;

    public SchoolGalleryAdapter(ArrayList<Gallery> arr, LinearLayout linearlayoutsize, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        Gallery courseDetail=arr.get(i);
