...
public class CollegeGalleryVideoAdapter extends RecyclerView.Adapter<CollegeGalleryVideoAdapter.MyViewHolder> {
    ...
    public CollegeGalleryVideoAdapter(ArrayList<Video> arr, LinearLayout linearlayoutsize, Context context) {
