...
public class SchoolFacilityAdapter extends RecyclerView.Adapter<SchoolFacilityAdapter.MyViewHolder> {
    ...
    Activity activity;
    public SchoolFacilityAdapter(ArrayList<Facilities> facilityDataArrayList, Context context) {
        this.arr = arr;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        Facilities facilityData=facilityDataArrayList.get(i);
