...
public class DisReplyAdapter extends RecyclerView.Adapter<DisReplyAdapter.MyViewHolder>
{

    Context context;
    Activity activity;
    List<com.eleganzit.tag.model.discussion.ReplyList> ansLists;
    public DisReplyAdapter(List<com.eleganzit.tag.model.discussion.ReplyList> ansLists, Context context) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int i) {
        com.eleganzit.tag.model.discussion.ReplyList ans=ansLists.get(i);
