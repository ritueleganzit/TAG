...
public class SchoolHomeFacilityAdapter extends RecyclerView.Adapter<SchoolHomeFacilityAdapter.MyViewHolder> {
    ...
    Context context;
    ArrayList<Facility> facilityDataArrayList;
    int h;
    ProgressDialog progressDialog;
    Activity activity;
    public SchoolHomeFacilityAdapter(ArrayList<Facility> facilityDataArrayList, Context context) {
        this.arr = arr;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        Facility facilityData=facilityDataArrayList.get(i);
       // myViewHolder.imageView.getLayoutParams().width= (int) (getScreenWidthInPXs(context,activity)/3.3);
        ...
        Log.d("dsadad",""+facilityData.getFacilityIcon());
myViewHolder.nam.setText(""+facilityData.getFacilityName());
        Glide
                .with(context)
                .load(facilityData.getFacilityIcon())
